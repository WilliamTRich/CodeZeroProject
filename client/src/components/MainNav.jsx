  ...
  return (
    <div className={'flex h-1/6 px-4 py-2 w-full items-center bg-accent border-b-2 border-b-highlight'}>
      ...
      <div className={'flex items-center space-x-4'}>
        <button
          className={
            'px-6 py-2 text-base sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl bg-highlight text-background border-background border-2 hover:bg-secondary hover:text-primary'
          }
